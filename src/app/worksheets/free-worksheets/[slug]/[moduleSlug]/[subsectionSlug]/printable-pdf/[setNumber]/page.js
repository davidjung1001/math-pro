...
export default async function PrintableWorksheetPage({ params }) {
  ...
  const lessonPageUrl = `/worksheets/free-worksheets/${slug}/${moduleSlug}/${subsectionSlug}`;
  ...
  return (
    <div className='no-print'>
      ...
      <div className="no-print p-4 bg-gray-800">
        <Link
          href={lessonPageUrl}
          className="inline-flex items-center text-blue-300 hover:text-white transition duration-150"
        >
          <svg 
...
          </svg>
          <span className="font-medium text-sm sm:text-base">Back to Lesson: {subsection.subsection_title}</span>
        </Link>
      </div>
